...
// Función para obtener fecha de hoy en local (Perú)
...
export default function DialogCrearMedico({ open, onClose }) {
  ...
  const [form, setForm] = useState({
    ...
    descripcion: "",
    imagen: "",
    fechaContratacion: getFechaHoyLocal(),
    tipoContrato: "FIJO",
    tipoMedico: "",
    correo: "",
    password: "",
  ...
  const handleSubmit = (e) => {
    ...
    const payload = {
      ...
      imagen: form.imagen,
      // Usa la fecha local SIEMPRE
      fechaContratacion: getFechaHoyLocal() + "T08:00:00",
